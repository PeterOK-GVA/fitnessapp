...
class CancelRestTimerUseCaseTest {
    ...
    @Test
    fun `cancel clears repository, stops service, and cancels alarm`() = runTest(main.dispatcher) {
        ...
        val useCase = CancelRestTimerUseCase(repo, controller, scheduler)
        ...
        scheduler.cancelCount shouldBe 1
    }
